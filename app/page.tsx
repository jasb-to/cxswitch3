                ...
                >
                  ...
                  <div className="px-6 py-6 space-y-5">
                    ...
                    <div className="border-t border-gray-800/50 pt-4">
                      <p className="text-xs text-gray-600 uppercase tracking-widest font-bold mb-2.5">4H Trend</p>
                      <div className="space-y-1.5">
                        ...
                        <div className="flex justify-between items-center text-sm">
                          <span className="text-gray-500">SMA Distance</span>
                          <span className="text-white font-mono text-xs bg-gray-800/30 px-2 py-1 rounded">
                            {signal.layer1.smaDistance.toFixed(2)}%
                          </span>
                        </div>
                      </div>
                    </div>
                    ...
                    {/* Layer 2 - 1H */}
                    <div className="border-t border-gray-800/50 pt-4">
                      <p className="text-xs text-gray-600 uppercase tracking-widest font-bold mb-2.5">1H Signal</p>
                      <div className="space-y-1.5">
                        <div className="flex justify-between items-center text-sm">
                        ...
                        <div className="flex justify-between items-center text-sm">
                          <span className="text-gray-500">SMA Distance</span>
                          <span className="text-white font-mono text-xs bg-gray-800/30 px-2 py-1 rounded">
                            {signal.layer2.smaDistance.toFixed(2)}%
                          </span>
                        </div>
                      </div>
                    </div>
                    ...
                    {/* Layer 3 - 15M */}
                    <div className="border-t border-gray-800/50 pt-4">
                      <p className="text-xs text-gray-600 uppercase tracking-widest font-bold mb-2.5">15M Trigger</p>
                      <div className="flex justify-between items-center text-sm">
                      ...
                      <div className="border-t border-gray-800/50 pt-4 mt-2">
                        ...
                        <div className="space-y-2 text-sm bg-gray-900/30 rounded-lg p-3 border border-gray-800/30">
                          ...
                          <div className="flex justify-between">
                            ...
                            <span className="text-white font-bold text-xs">{signal.holdDuration}</span>
                          </div>
                          <div className="flex justify-between">
