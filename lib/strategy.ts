// lib/strategy.ts — v30.11 "Directional Trendlines + Structural Consistency"
// ============================================================
// 2 architectural changes:
// 1. Trendlines are directional: LONG = swing lows only, SHORT = swing highs only
// 2. enforceTrendStructure filters pivots so each follows the trend (lower highs / higher lows)
// This fixes mixed-geometry regression (SOL R²=0) without adding new setup classes
